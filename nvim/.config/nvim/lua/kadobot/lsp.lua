...
wk.register({
    ...
    ['X'] = {':Telescope lsp_range_code_actions<CR>', 'Range Code Actions'},
    ['z'] = {':Lspsaga show_line_diagnostics<CR>', 'Line Diagnostics'},
    ...
    ['p'] = {':Lspsaga diagnostic_jump_prev<CR>', 'Go to prev diagnostic'},
